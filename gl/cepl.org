...
** Buffers are big blocks of bytes
   ...
   :time:     0:14:49
   :END:
 the bytes in buffers are of some types and they can be multipel so they are collection array of data of some type. 
...
* Rendering Pipeline
  :PROPERTIES:
  :time:     0:56:23
  :DIR:      /home/bpanthi/lisp/rcc/gl/.data/
  :END:
[[attachment:mpv-screenshotBLKh78.png]]
