(ql:quickload '(:alexandria :serapeum :drakma))
(defpackage :aoc
...
(defun url (day)
  ...
  (format nil "https://adventofcode.com/2022/day/~d/input" day))

(defun file (day)
  (check-type day (integer 1 *))
  (pathname (format nil "~~/Development/lisp/rcc/aoc/2022/inputs/~d" day)))
